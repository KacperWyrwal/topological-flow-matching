...
class OceanDataset(FMDataset):
    ...
    @classmethod
    def from_disk(cls, ambient: AmbientCoordinates | str, device: torch.device, dtype: torch.dtype) -> "OceanDataset":
        harm_eigvals, grad_eigvals, curl_eigvals = OceanDataset.load_eigvals()
        ...
        harm_eigvecs, grad_eigvecs, curl_eigvecs = OceanDataset.load_eigvecs()
